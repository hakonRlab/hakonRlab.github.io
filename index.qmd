...
Variable selection with the [projpred](https://mc-stan.org/projpred/index.html) package
...
```{r, eval=FALSE}
#Knot values last updated June 2 2022

knot1 <- 0.2 #PSAPreopKnot1
knot2 <- 4.78 #PSAPreopKnot2
knot3 <- 7.3 #t PSAPreopKnot3
